...
const activityData: ActivitiesModel[] = [
  {
    ...
    TempDescription:
      "BJJ är i vanliga fall en fullkontaktsform där man tillsammans med en träningspartner utför olika tekniker och rörelser. Detta är nu tillsvidare anpassat med hänsyn till de rådande omständigheterna och träningspartnern har ersatts med en träningsdocka som du nu utför tekniker och rörelser på.",
  ...
  },
  {
    ...
    TempDescription:
      "Submission Wrestling är i vanliga fall en fullkontaktssport där man tillsammans med en träningspartner utför olika tekniker och rörelser. Detta är nu tillsvidare anpassat med hänsyn till de rådande omständigheterna och träningspartnern har ersatts med en träningsdocka som du nu utför tekniker, drillar och rörelser på.",
  ...
  },
  {
    ...
    TempDescription:
      "Som tidigare är detta passet utan eller med endast minimal fysisk kontakt, alla övningar och tekniker sker på träningssäckar och träningsdockor och kommer att fortsätta med detta tillsvidare.",
    Name: "Fitness MMA",
    Link: "",
    Url: "fitness-mma",
    Trainers: [
  ...
  },
  {
    ...
    TempDescription:
      "Kick- och Thaiboxning är i vanliga fall en fullkontaktssport där man tillsammans med en träningspartner utför olika tekniker och rörelser. Detta är nu tillsvidare anpassat med hänsyn till de rådande omständigheterna och endast anpassad mittsträning är tillåten utöver den vanliga fysen där man tränar individuellt.",
  ...
  },
  {
    ...
    TempDescription:
      "Boxning är i vanliga fall en fullkontaktssport där man tillsammans med en träningspartner utför olika tekniker och rörelser. Detta är nu tillsvidare anpassat med hänsyn till de rådande omständigheterna och endast anpassad mittsträning är tillåten utöver den vanliga fysen där man tränar individuellt.",
    Name: "Boxning",
    Link: "",
    Url: "boxning",
    Trainers: [
  ...
  },
  {
    ...
    TempDescription:
      "Tidigare förekom det även moment där man i par eller mindre grupp genomförde övningar som krävde en fysisk kontakt, detta är nu bortplockat tillsvidare med hänsyn till de rådande omständigheterna.",
    Name: "Limitless HIIT",
    Link: "",
    Url: "limitless-hiit",
    Trainers: [
  ...
  },
  {
    ...
    TempDescription:
      "Hikari Do är i vanliga fall en idrott som även innefattar moment med fysisk kontakt där man tillsammans med en träningspartner utför olika tekniker och rörelser. Detta är nu tillsvidare anpassat med hänsyn till de rådande omständigheterna och endast anpassad mittsträning är tillåten utöver den vanliga fysen där man tränar individuellt.",
    Name: "Hikari Do",
  ...
  },
  {
    ...
    TempDescription:
      "Då detta passet innebär fri träning är detta numera tillsvidare anpassat med hänsyn till de rådande omständigheterna och endast anpassad mittsträning är tillåten utöver den ordinarie individuella träningen som är godkänd, dvs ingen träning som innefattar fysisk kontakt är tillåten, använd befintlig träningsutrustning såsom träningsdockor, träningssäckar mm.",
    Name: "Open Mat",
    Link: "",
    Url: "open-mat",
    Trainers: [
