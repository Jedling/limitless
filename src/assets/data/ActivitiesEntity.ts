...
const activityData: ActivitiesModel[] = [
  ...
  {
    Id: 5,
    Description: "Traditionell boxning där du slipar på både grundläggande tekniker och varierande kombinationer samt utvecklar fotarbetet i samband med tuff träning. Mittsar och säckar är en stor del av träningen där balans och koordination utmanas på ett lekfullt sätt, ett perfekt tillfälle för dig att träna tillsammans med en vän eller partner. Boxning är också en självförsvarsutvecklande idrott för alla, helt enkelt en utmanande och rolig träning på samma gång.",
    Name: 'Boxning',
    Link: '',
    Url: 'boxning',
    Trainers: [
